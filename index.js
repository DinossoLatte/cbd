...
function req1(data){
	...
	for(var i=0; i<info.top.length; i++){
	    ...
	    var p2 = new Promise((accept) => accept(req2(game, data)) );
	}
      }
    }
...
function req2(game, data){
	...
	for(var j=0; j<infoChannel.streams.length; j++){
		...
		var p3 = new Promise((accept) => accept(req3(channels, game, data)) );
	}
      }
    }
...
function req3(channels, game, data){
